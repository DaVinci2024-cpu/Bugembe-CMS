...
import { Camera, Image as ImageIcon, X, ChevronLeft, ChevronRight, HelpCircle } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-500 max-w-3xl mx-auto text-xs sm:text-sm md:text-base leading-relaxed">
            Take a visual tour of Bugembe Islamic Institute. Browse our classrooms, state-of-the-art laboratories, prayer gatherings, and athletic events.
          </p>
        </motion.div>
              ...
              {filteredItems.map((item, index) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-[#0c2340]/90 opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-end p-6 z-10">
                    <span className="text-[9px] text-[#d4af37] font-mono uppercase tracking-widest mb-1.5 font-bold">
                      {item.category}
                    </span>
                    <h4 className="text-white font-serif font-bold text-sm sm:text-base mb-1">
                      {item.title}
                    </h4>
          ...
          >
            ...
            >
              ...
              <div className="text-center text-white mt-4 space-y-1.5 bg-black/60 p-5 rounded-xl border border-white/5 backdrop-blur-md">
                ...
                <h4 className="font-serif font-semibold text-base sm:text-lg">

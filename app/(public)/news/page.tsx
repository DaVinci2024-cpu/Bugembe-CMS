...
import { Search, Clock, ArrowRight, Sparkles, Calendar, BookOpen } from "lucide-react";
...
export default function NewsPage() {
  ...
  // Filter out the featured article from standard list to prevent duplicates unless filtering
  const remainingArticles = newsArticles.filter(
    (a) => a.id !== featuredArticle.id || searchQuery || selectedCategory !== "all"
  );
        ...
        <section id="news-grid-block">
          {filteredArticles.length === 0 ? (
            <div className="text-center py-16 bg-white rounded-xl border border-gray-100 shadow-inner">
              ...
              <p className="text-xs text-gray-400 mt-1 max-w-sm mx-auto">We couldn&apos;t find any articles matching your search criteria. Try looking up broader keywords.</p>
            </div>
          ) : (

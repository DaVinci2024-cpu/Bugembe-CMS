...
export default function AlumniPage() {
  const [alumniList, setAlumniList] = useState<AlumniProfile[]>(() => getLocalAlumni());
  ...
  const handleJoinSubmit = (e: React.FormEvent) => {
    ...
    const newProfile = saveLocalAlumnus({
      fullName,
  ...
  const filteredAlumni = alumniList.filter((a) => {
    ...
    return matchesSearch && matchesYear && matchesProfession && matchesFeatured;
  });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-500 max-w-3xl mx-auto text-xs sm:text-sm md:text-base leading-relaxed">
            Our alumni are leaders, doctors, educators, entrepreneurs, and sharia scholars making an impact across East Africa and beyond. Join our registry to network and sponsor.
          </p>
        ...
        >
          ...
          <h3 className="text-xl sm:text-2xl font-serif font-semibold text-white mb-8">
            Our Global Alumni Network in Numbers
          </h3>
        ...
        {/* 3. Alumni Spotlight (Editorial) - Premium layout with parallax scale */}
        <section className="mb-24 scroll-mt-24" id="alumni-spotlight">
          ...
          >
            ...
            <div className="lg:col-span-2 p-8 sm:p-12 flex flex-col justify-center space-y-6">
              ...
              <h4 className="text-2xl font-serif font-bold text-[#0c2340]">
                Sheikh Dr. Anas Lwanga (Class of 2004)
              </h4>
              ...
              <div className="border-t border-gray-100 pt-4 text-xs text-gray-400 space-y-1">
                <p><strong>Current Role:</strong> Professor of Islamic Law at Islamic University in Uganda</p>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <span className="text-[10px] text-gray-400 font-mono">
                          Graduated {alum.graduationYear} (P/S)
                        </span>
                      </div>
                    </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16 scroll-mt-24" id="registration-form-section">
          ...
          <div className="bg-white p-8 sm:p-10 rounded-2xl border border-gray-100 shadow-md">
            ...
            <p className="text-xs text-gray-400 mb-6">Reconnect and register your professional records to network with active cohorts and scholars.</p>
            ...
            <form onSubmit={handleJoinSubmit} className="space-y-4 text-xs sm:text-sm">
              ...
              <button
                type="submit"
                className="w-full bg-[#0c2340] hover:bg-indigo-950 text-white font-bold py-3 px-6 rounded uppercase tracking-widest text-xs flex items-center justify-center space-x-2 transition-all"
              >
          ...
          {/* Intelligent CMS Recommendation sidebar */}
          <div className="space-y-8">
                ...
                {getRecommendedGroups().map((group) => (
                  ...
                  >
                    <div className="flex justify-between items-start gap-4">
                      <div>
                        <h4 className="font-serif font-semibold text-sm text-[#d4af37]">
                          {group.name}
                        </h4>
                        <p className="text-gray-400 text-[11px] font-mono pt-0.5">
                          {group.memberCountPlaceholder}
                        </p>
                      </div>
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm space-y-4">
              <h4 className="font-serif font-bold text-sm text-[#0c2340] uppercase tracking-wider">
                Alumni Mentorship Pledge
              </h4>
              <p className="text-gray-500 text-xs leading-relaxed">
                We organize Termly Guidance Seminars connecting registered alumni with current primary and secondary candidates. Share career tips, guide subject combinations, and keep Bugembe academic success flying high.
              </p>
            </div>
          </div>
        </section>

...
export default async function HomePage() {
  const [programs, newsArticles, galleryItems, testimonials] = await Promise.all([
  ...
  return <HomeContent programs={programs} newsArticles={newsArticles} galleryItems={galleryItems} testimonials={testimonials} />;
}

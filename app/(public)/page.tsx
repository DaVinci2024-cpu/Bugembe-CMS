    ...
    <div className="relative min-h-screen bg-[#fcfbf9]" id="home-page-root">
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" id="testimonials-section">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {parentStudentTestimonials.map((t) => (
            <div
              key={t.id}
              className="bg-white p-8 rounded-xl border border-gray-100 shadow-md flex flex-col justify-between h-full"
            >
              <div>
                {/* Stars */}

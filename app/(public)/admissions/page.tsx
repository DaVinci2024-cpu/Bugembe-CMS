...
import { CheckCircle, AlertTriangle, Download, Send, MessageSquare, ChevronDown, ChevronUp, HelpCircle } from "lucide-react";
import { motion, AnimatePresence } from "motion/react";
import { admissionsDetails, saveLocalMessage } from "@/lib/data";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-500 max-w-3xl mx-auto text-xs sm:text-sm md:text-base leading-relaxed">
            Welcome to Bugembe Islamic Institute. We streamline our enrollment to ensure parents find a transparent, values-driven admission track.
          </p>
        </motion.div>
        ...
        <section className="mb-24" id="process-section">
          <div className="text-center space-y-2 mb-12">
            <h3 className="text-2xl sm:text-3xl font-serif font-semibold text-[#0c2340]">
          ...
          >
            {admissionsDetails.process.map((p) => (
              <motion.div 
                key={p.step} 
                variants={{
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-24" id="requirements-section">
          ...
          >
            ...
            <ul className="space-y-4 text-xs sm:text-sm text-gray-600">
              {admissionsDetails.requirements.general.map((r, i) => (
          ...
          >
            ...
            <ul className="space-y-3 text-xs sm:text-sm text-gray-600">
              {admissionsDetails.requirements.boardingList.map((r, i) => (
          ...
          >
            ...
            <div className="space-y-4 z-10">
              ...
              <p className="text-gray-300 text-xs sm:text-sm leading-relaxed">
                Bugembe Islamic Institute is dedicated to keeping top-tier educational excellence affordable. 
                Our fees are divided cleanly into Tuition and Boarding charges based on your study level (Primary vs O/A Secondary levels).
              </p>
              <p className="text-gray-400 text-xs leading-relaxed">
                Scholarships and tuition reductions are granted annually to candidates showing brilliant UNEB entry qualifications or exceptional Quranic memorization (Hifz) speed.
              </p>
            </div>
            <motion.a
            ...
            {submitSuccess ? (
              ...
              >
                ...
                <p className="text-xs max-w-md mx-auto leading-relaxed">
                  Thank you for your interest in Bugembe Islamic Institute. We have logged your pre-admission details. You will receive an email or call shortly.
                </p>
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
        ...
        {/* 4. Frequently Asked Questions (FAQ Accoridon) */}
        <section id="faq-section" className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {admissionsDetails.faqs.map((faq, i) => {
              ...
              return (
                <div key={i} className="bg-white border border-gray-100 rounded-lg shadow-sm overflow-hidden">
                  ...
                  >
                    <span className="font-serif font-bold text-[#0c2340] text-sm sm:text-base pr-4">
                      {faq.question}
                    </span>
                    {isOpened ? (
                  ...
                  <AnimatePresence>
                    {isOpened && (
                      ...
                      >
                        <div className="px-6 py-5 text-gray-500 text-xs sm:text-sm leading-relaxed">
                          {faq.answer}
                        </div>
                      </motion.div>
                    )}

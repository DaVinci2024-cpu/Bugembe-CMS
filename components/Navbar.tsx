    ...
    <>
      ...
      <header
        className={`sticky top-0 w-full z-40 transition-all duration-300 ${
          isScrolled
            ? "bg-[#0c2340]/95 backdrop-blur-md shadow-lg py-3 border-b border-white/10"
            : "bg-[#0c2340] py-4 border-b border-white/5"
        }`}
        id="navbar-root"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center lg:hidden" id="mobile-toggle-btn">
            <button
              ...
              className="p-2 rounded-md text-gray-300 hover:text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-[#d4af37] transition-all duration-200"
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="lg:hidden bg-[#0c2340] border-t border-white/10"
              id="mobile-nav-panel"
            >
              <div className="px-2 pt-3 pb-6 space-y-1 sm:px-3">
                ...
                <div className="pt-4 px-4">
                  <Link
                    href="/admissions"
                    className="block w-full text-center py-3 bg-[#d4af37] text-[#0c2340] font-semibold text-sm tracking-wider uppercase rounded shadow-md hover:bg-amber-400 transition-colors"
                  >
                    Apply Online Now
                  </Link>
                </div>

...
export function Sidebar({ open, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 h-full w-[240px] shrink-0 bg-[#0c2340] border-r border-white/10 flex flex-col justify-between text-slate-300 transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${
      ...
      <div className="flex flex-col flex-1 overflow-y-auto">
        <div className="border-b border-white/10 flex items-center">
          <button
            ...
            className="p-4 flex items-center gap-2.5 text-left cursor-pointer hover:bg-white/5 transition-colors group flex-1 min-w-0"
          >
          ...
          <button
            ...
            className="p-4 text-slate-400 hover:text-white cursor-pointer lg:hidden shrink-0"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
